...
export default function LoadingScreen() {
  ...
  return (
    <div className="fixed inset-0 bg-cream flex flex-col items-center justify-center z-50">
      ...
      >
        <h1 className="text-4xl md:text-6xl font-bold text-dark-brown mb-8 text-center">Nora Wang</h1>
        
        <div className="relative h-16 w-64 mx-auto">
          {/* Paw outline */}
          <svg 
            className="absolute top-0 left-0 w-full h-full text-dark-cream" 
            viewBox="0 0 512 512" 
            fill="currentColor"
          >
        ...
        <p className="text-medium-brown mt-4">Loading portfolio... {progress}%</p>
      </motion.div>
    </div>
  )
}